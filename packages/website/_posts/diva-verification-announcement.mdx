...
One of the main problems in the context of airdrops are Sybil attackers who try to maximize their token allocation during token drops by creating multiple 
...
were diluting the allocation of single-account users. 
...
suggested users to create multiple accounts. Initial analysis of the testnet data also suggests that some users tried to participate multiple times.

Our goal is to ensure a 

To ensure a fair DIVA token distribution and to address the concerns of the DIVA community, we will conduct an additional verification step. Details about the procedure
will be announced in a separate article. It won't be KYC, though. 
