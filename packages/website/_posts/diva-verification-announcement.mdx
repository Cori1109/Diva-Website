...
thereby diluting the rewards of single-account users.
...
an **additional verification round** for testnet participants. Details about the exact verification procedure will be disclosed at the start of the verification period.  
...
* The verification process will be very simple and efficient and will not involve KYC.
