...
More than 11k registered users missed the verification process. As users have spent a significant amount of their time to complete the tasks, we decided to also reward 
non-verified users with a reduced reward:  

- **1.78** DIVA tokens per completed task (200 points)
- **40** DIVA tokens for full completion (4500 points)

Those rewards are come on top of the initially planned reward pool and do not dilute verified users. Overall, a total of 1.37m DIVA tokens have been allocated to more than 25'200 users.
That is 37% more than originally planned.
