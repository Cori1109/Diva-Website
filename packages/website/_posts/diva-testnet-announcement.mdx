...
**Note that each verified Discord user can only register one single account.** Users have time to register and complete all tasks until **30th September 2022**. The testnet app will be published on Saturday, 
