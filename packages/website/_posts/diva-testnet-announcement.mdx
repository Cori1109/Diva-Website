...
or create a simple webpage to allow users to bet on the outcome of the Champions League Finals, everything can be powered by DIVA Protocol.
...
model, to facilitate the exchange of those assets in a decentralized way without giving up custody.

Both the DIVA Protocol smart contracts as well as the app code will be open-sourced at mainnet launch later this year to inspire developers 
to realize their own prediction and insurance product ideas.
...
- **3.0x**: Users that complete all tasks AND hold a whale from our founders’ 888whales.art NFT collection at the end of the testnet, will receive a “whale multiple” of 3.0x on their total score resulting in 9000 points. 
...
![register](../public/images/posts/register.png)
...
![register](../public/images/posts/testnet_bot.png)
