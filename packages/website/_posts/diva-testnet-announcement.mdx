...
|[Create a BUY LIMIT Order that gets filled](https://docs.divaprotocol.io/guides/diva-app-training/trade#create-a-buy-limit-order)|200|
|[Create a SELL LIMIT Order that gets filled](https://docs.divaprotocol.io/guides/diva-app-training/trade#create-a-sell-limit-order)|200|
