...
The following screenshot gives you an idea where we are heading in terms of design on the trading page.
<p align="center">
...
If you haven't followed all the questions but want to test your knowledge about DIVA Protocol, head over to our [documentation](https://docs.divaprotocol.io/guides/quiz) where you will find all questions. We have decided to not publish the answers yet to increase the learn effect ;-)
